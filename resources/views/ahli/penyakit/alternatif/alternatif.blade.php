            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">alternatif Penyakit</h4>
                    ...
                    <div class="col-12">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2 ms-auto">
                                <a href="{{ route('alternatif.penilaian.penyakit.form') }}" class="btn btn-outline-secondary btn-sm">
                                    ...
                                    <td style="text-align: center; width: 100px;">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <form action="{{ route('alternatif.penyakit.delete', $item->id) }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation"
                                                action="{{ route('alternatif.penyakit.put', $item->id) }}" method="POST"
                                                novalidate>
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="{{ route('alternatif.penyakit.post') }}" method="POST"
                        novalidate>
                        @csrf
                        <div class="mb-3">
