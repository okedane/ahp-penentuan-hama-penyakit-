                    ...
                    <div class="col-12">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2 ms-auto">
                                <a href="{{ route('matriks.penyakit', $kriteria->id) }}"
                                    ...
                                    <td style="text-align: center; width: 100px;">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <form action="{{ route('subKriteria.penyakit.delete', $item->id) }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation"
                                                action="{{ route('subKriteria.penyakit.put', $item->id) }}"
        ...
        <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="needs-validation" action="{{ route('subKriteria.penyakit.post') }}"
                            method="POST" novalidate>
                            @csrf
