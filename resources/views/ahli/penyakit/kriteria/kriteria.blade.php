                    ...
                    <div class="col-12">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2 ms-auto">
                                <a href="{{ route('kriteria.penyakit.matriks') }}" class="btn btn-outline-secondary btn-sm">
                                    ...
                                    <td style="text-align: center; width: 100px;">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="{{ Route('subKriteria.penyakit.index', $item->id) }}"
                                                    class="btn btn-soft-primary waves-effect waves-light"
                                                    style="padding: 3px 6px;">
                                                    <i class="mdi mdi-eye font-size-16 align-middle"></i>
                                                </a>

                                                <form action="{{ route('kriteria.penyakit.delete', $item->id) }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form class="needs-validation"
                                                action="{{ route('kriteria.penyakit.put', $item->id) }}" method="POST"
                                                novalidate>
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
    ...
    <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="{{ route('kriteria.penyakit.post') }}" method="POST" novalidate>
                        @csrf
                        <div class="mb-3">
